...
public class MultipleImagesV2 {
    ...
    public static void main(String[] args) throws IOException, DocumentException {
        ...
        new MultipleImagesV2().createPdf(DEST);
    }
    ...
    public void createPdf(String dest) throws IOException, DocumentException {
       ...
       // PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream(dest));
        ...
        //https://stackoverflow.com/questions/51270252/java-best-way-to-convert-json-to-pdf
        //https://stackoverflow.com/questions/6103260/return-pdf-to-browser-using-json-and-mvc
        ...
        Files.write(Paths.get("d:\\silvio\\cartaoAgente.pdf"), pdfBytes);
