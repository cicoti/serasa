...
public class WaterMark3 {
    public static void main(String[] args) throws IOException {
    	...
    	BufferedImage im1 = ImageIO.read(new File("d:\\silvio\\circulo_transparente.png"));

        BufferedImage im2 = ImageIO.read(new File("d:\\silvio\\fotoAgente.png"));

        im2 = arredondarImagem(im2);
...
/*
       ...
       //g.setComposite(AlphaComposite.getInstance(AlphaComposite.DST_OVER, 0.4f));
