...
public class SerasaDesenho {
	...
	public static final String SERASA_SCORE = "D:\\silvio\\projetos2\\workspace\\CARTAO\\serasa_score_imagem.png";
	...
	public static void main(String[] args) {
		...
		// Separação
         ...
         // Separação
		   ...
		   BufferedImage bufferImagemSerasaScore = ImageIO.read(new File(SERASA_SCORE));
		   Graphics2D graphicsImagemSerasaScore = bufferImagemSerasaScore.createGraphics();
		   graphicsImagemSerasaScore.setColor(Color.decode("#1394D6"));
		   java.awt.Font fontSerasaScore = new java.awt.Font("Helvetica", Font.HELVETICA, 54);
		   graphicsImagemSerasaScore.setFont(fontSerasaScore);

		   String textScore = String.valueOf(score);

		   int posicao = (bufferImagemSerasaScore.getWidth()/2) - ((textScore.length()*36)/2);

		   graphicsImagemSerasaScore.drawString(textScore, posicao, posicaoCentroY);
		  ...
		  AffineTransform saveTransform = graphicsImagemSerasaScore.getTransform();
		  AffineTransform identity = new AffineTransform();
		  graphicsImagemSerasaScore.setTransform(identity);
		  graphicsImagemSerasaScore.setColor(Color.BLACK);
		  graphicsImagemSerasaScore.translate(x, y);
		  graphicsImagemSerasaScore.rotate(Math.toRadians(angulo));
		  graphicsImagemSerasaScore.scale(0.95, 0.95);
		  graphicsImagemSerasaScore.fill(shape);
		  graphicsImagemSerasaScore.dispose();

		  Image serasaScoreImage = Image.getInstance(bufferImagemSerasaScore, null);
		  serasaScoreImage.scalePercent(35);
