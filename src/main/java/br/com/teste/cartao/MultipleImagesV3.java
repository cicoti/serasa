...
public class MultipleImagesV3 {
    public static final String[] IMAGES = {
        "D:\\silvio\\projetos2\\workspace\\CARTAO\\cartaoCorretor.png",
        "D:\\silvio\\projetos2\\workspace\\CARTAO\\fotoAgente.png",
    ...
    public static void main(String[] args) throws IOException, DocumentException {
        ...
        new MultipleImagesV3().createPdf(DEST);
    }
    ...
    public void createPdf(String dest) throws IOException, DocumentException {
        ...
        for (int i = 0;i < IMAGES.length; i++) {
        	...
        	if(i==1) {
        	    ...
        	    inputImage =  redimencionarImagem(inputImage, inputImage.getType(), 180, 180);
        	        ...
        	        inputImage = arredondarImagem(inputImage);
...
*/
        	     ...
        	     img = Image.getInstance(inputImage, null);
